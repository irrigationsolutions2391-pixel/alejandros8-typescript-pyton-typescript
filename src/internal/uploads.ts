...
import type { Alejandros8TypescriptPyton } from '../client';
...
export const maybeMultipartFormRequestOptions = async (
  opts: RequestOptions,
  fetch: Alejandros8TypescriptPyton | Fetch,
 ...
 */
function supportsFormData(fetchObject: Alejandros8TypescriptPyton | Fetch): Promise<boolean> {
